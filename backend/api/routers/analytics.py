...
def get_financial_reports(db: Session = Depends(get_db)):
    ...
    # Just mocking revenue for now since we don't have a revenue model
    ...
    metrics = {
        ...
        "avgEfficiency": 8.5, # Mocked average efficiency
        "avgROI": avg_roi
    }
    
    # Build per-vehicle reports
    ...
    for v in vehicles:
        ...
        v_revenue = 5000.00 # Mocked per vehicle
